...
Проект находится в активной разработке. `README` отражает текущую структуру ветки `suchGlobe`, включая:

- realistic 3D globe
- 2D/3D режимы
- статус источника каталога
- N2YO + fallback на локальные TLE
- timeline и симуляцию времени
